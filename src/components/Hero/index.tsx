            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Transforming Ideas into Digital Success with Powerful Marketing & Custom Software Solutions.
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  We are a full-service agency specializing in Digital Marketing and Software Development, dedicated to helping businesses grow and thrive in the digital world. From creating high-performing websites and custom software solutions to executing result-driven marketing campaigns across social media, SEO, and paid ads—we bring your ideas to life with innovation and strategy. Whether you are a startup or an established brand, our team is here to provide tailored solutions that deliver real results and long-term success.
                </p>
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    ...
                    "
                  >
                    <span>We Are Special For</span>
                    <ArrowTopRightOnSquareIcon className="h-4 w-4" />
                  </Link>
                  {/* Uncomment if you want a secondary button
                  <Link
